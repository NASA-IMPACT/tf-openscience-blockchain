...
module "managed_blockchain" {
  source                    = "https://github.com/NASA-IMPACT/tf_aws_managed_blockchain/releases/download/v1.1.5.dev/tf_aws_managed_blockchain.zip"
  ...
  ecs_container_folder_path = "${path.module}/os-blockchain-api/sync-api/rest-api"
  ...
  docker_file_path = "${path.module}/os-blockchain-api/Dockerfile"
}
